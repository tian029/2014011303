package com.example.alana.exercise21;

import android.net.Uri;
import android.provider.BaseColumns;

/**
 * Created by Alana on 2016/9/29.
 */

public class Words {

    public static final String AUTHORITY ="com.example.alana.exercise21.wordscontentprovider.provider";
