...
public class MainActivity extends AppCompatActivity  implements WordItemFragment.OnFragmentInteractionListener, WordDetialFragment.OnFragmentInteractionListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_insert:
                ...
                InsertDialog();
                return true;
            case R.id.action_search_on_net:
                Intent intent=new Intent(MainActivity.this,NetSearchingActivity.class);
    ...
    public void onWordItemClick(String id) {
        ...
        if(isLand()) {//横屏的话则在右侧的WordDetailFragment中显示单词详细信息
            ...
            intent.putExtra(WordDetialFragment.ARG_ID, id);
            startActivity(intent);
        }
    ...
    private void ChangeWordDetailFragment(String id){
        ...
        arguments.putString(WordDetialFragment.ARG_ID, id);
        Log.v(TAG, id);
