package com.example.alana.exercise20;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void DeleteDialog(final String strId){
        new android.app.AlertDialog.Builder(this).setTitle("删除单词").setMessage("是否真的删除单词?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
